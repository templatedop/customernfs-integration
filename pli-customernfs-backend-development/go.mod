...
require (
	...
	gitlab.cept.gov.in/it-2.0-common/n-api-bootstrapper v0.0.18 // indirect
	gitlab.cept.gov.in/it-2.0-common/n-api-db v0.0.4 // indirect
	...
	gitlab.cept.gov.in/it-2.0-common/n-api-validation v0.0.5 // indirect
